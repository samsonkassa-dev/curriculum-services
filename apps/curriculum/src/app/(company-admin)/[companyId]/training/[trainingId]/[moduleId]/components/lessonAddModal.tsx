...
export function LessonAddModal({ 
  ...
  const modalTitle = readOnly ? "View Lesson" : (isEdit ? "Edit Lesson" : "Create Lesson")
          ...
          <div className="grid gap-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {readOnly ? (
                  <div className="p-2 bg-gray-50 rounded border text-gray-700">{formData.name}</div>
                ) : (
                  <Input
              ...
              <div className="space-y-2">
                ...
                {readOnly ? (
                  <div className="p-2 bg-gray-50 rounded border text-gray-700">{formData.objective}</div>
                ) : (
                  <Input
            ...
            <div className="space-y-2">
              ...
              {readOnly ? (
                <div className="p-2 bg-gray-50 rounded border text-gray-700 min-h-[100px]">{formData.description}</div>
              ) : (
                <Textarea
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {readOnly ? (
                  <div className="p-2 bg-gray-50 rounded border text-gray-700">{formData.duration}</div>
                ) : (
                  <Input
                    type="number"
              ...
              <div className="space-y-2">
                ...
                {readOnly ? (
                  <div className="p-2 bg-gray-50 rounded border text-gray-700">
                    {formData.durationType === "HOURS" ? "Hours" :
                     formData.durationType === "DAYS" ? "Days" :
                     formData.durationType === "WEEKS" ? "Weeks" : "Months"}
                  </div>
                ) : (
                  <Select
            ...
            {readOnly ? (
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="p-2 bg-gray-50 rounded border text-gray-700 min-h-[40px]">
                    {selectedMethodNames || "None selected"}
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">Technology Integrations</label>
                  <div className="p-2 bg-gray-50 rounded border text-gray-700 min-h-[40px]">
                    {selectedTechNames || "None selected"}
                  </div>
                </div>
              </div>
            ) : (
