  ...
  function AssessmentContent({ 
    ...
    return (
      <div className="flex items-center gap-2 p-4 bg-gray-50/50 rounded-md text-gray-500">
        ...
        <span>No assessment methods added yet</span>
      </div>
    )
  }
      ...
      <div className="space-y-4">
        <Accordion type="single" collapsible defaultValue="" className="space-y-4">
          {sections.map((section, index) => (
            <AccordionItem key={section.id} value={section.id} className="border-[0.5px] border-[#CED4DA] rounded-lg">
