...
export default function BaseData() {
  ...
  return (
    <div className="flex md:flex-row flex-col min-h-screen md:w-[calc(100%-85px)] lg:pl-[85px] md:pl-[50px] md:mx-auto w-full overflow-hidden">
      <div className="md:w-[30%] w-full mx-auto p-5">
